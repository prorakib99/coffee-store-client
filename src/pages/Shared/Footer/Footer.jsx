    ...
    return (
        <div style={{ backgroundImage: `url(${footerBg})` }} className="w-full pt-12 pb-10 bg-cover bg-center">
            <div className='container mx-auto px-8'>
                <div className='lg:grid lg:grid-cols-[7fr_5fr] flex flex-col-reverse gap-10 justify-between items-center'>
                    <div>
                        <Link to="/">
                            <img className='h-16' src={footerLogo} alt="" />
                        </Link>
                        <h3 className="text-stone-800 text-[45px] mt-3 font-normal font-['Rancho']">Espresso Emporium</h3>
                    ...
                    <div>
                        ...
                        <form>
                            ...
                            <input type="submit" value="Send Message" className="w-[150px] text-stone-800 text-2xl font-normal font-['Rancho'] h-12 rounded-[30px] border-2 border-stone-800" />
                        </form>
                    </div>
                </div>
            </div>
